...
if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET) {
  ...
  console.info('Google OAuth strategy registered');
} else {
  console.info('Google OAuth not configured (GOOGLE_CLIENT_ID/SECRET missing)');
}
...
if (process.env.GITHUB_CLIENT_ID && process.env.GITHUB_CLIENT_SECRET) {
      ...
      async (accessToken, refreshToken, profile, done) => {
        try {
          ...
          user = await User.create({
            ...
            socialLogins: { githubId: profile.id },
          });
  ...
  console.info('GitHub OAuth strategy registered');
} else {
  console.info('GitHub OAuth not configured (GITHUB_CLIENT_ID/SECRET missing)');
}
